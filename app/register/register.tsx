  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex mb-4">
        <button 
          className={`flex-1 py-2 ${accountType === 'customer' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
          onClick={() => setAccountType('customer')}
        >
          Customer
        </button>
        <button 
          className={`flex-1 py-2 ${accountType === 'restaurant' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
